	...
	<span class="add_button"><a href="index.php?c=login&m=logout">-登出</a></span>
	<span class="add_button"><a href="javascript:changepsw();">#修改密码</a></span>
	<!-- <span class="add_button"><a href="index.php?c=admin&m=shear">+统计</a></span> -->
	<span class="add_button"><a href="index.php?c=admin&m=order">+预约购车</a></span>
	<!-- <span class="add_button"><a href="index.php?c=admin&m=prize">+奖品列表</a></span> -->
