...
<head>
	...
	function chgPage(ele){
		...
		window.location.href = "index.php?c=admin&m=customer&page="+page;
	}
	</script>
</head>
<body>
...
<!-- 	<span class="add_button"><a href="javascript:changepsw();">#修改密码</a></span> -->
	...
	<div style="margin: 0 15px 0 15px;">
		<a href="<?php echo site_url('c=admin&m=customerexport')?>">导出全部到excel</a>
	</div>
	<div id="body">
		...
		if(!empty($list)){
			foreach ($list as $item){
				...
				<tr>
					...
					<td><?php echo $item->raffle_date;?></td>
