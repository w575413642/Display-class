...
-- ----------------------------
-- Table structure for raeton_17_addup
-- ----------------------------
DROP TABLE IF EXISTS `raeton_17_addup`;
CREATE TABLE `raeton_17_addup` (
  `id` int(255) NOT NULL,
...
-- ----------------------------
-- Records of raeton_17_addup
-- ----------------------------
INSERT INTO `raeton_17_addup` VALUES ('1', '0');

-- ----------------------------
-- Table structure for raeton_17_customer
-- ----------------------------
DROP TABLE IF EXISTS `raeton_17_customer`;
CREATE TABLE `raeton_17_customer` (
...
-- ----------------------------
-- Records of raeton_17_customer
-- ----------------------------

-- ----------------------------
-- Table structure for raeton_17_customer_msg
-- ----------------------------
DROP TABLE IF EXISTS `raeton_17_customer_msg`;
CREATE TABLE `raeton_17_customer_msg` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of raeton_17_customer_msg
-- ----------------------------

-- ----------------------------
-- Table structure for raeton_17_customer_prize
-- ----------------------------
DROP TABLE IF EXISTS `raeton_17_customer_prize`;
CREATE TABLE `raeton_17_customer_prize` (
...
-- ----------------------------
-- Records of raeton_17_customer_prize
-- ----------------------------

-- ----------------------------
-- Table structure for raeton_17_customer_remainder
-- ----------------------------
DROP TABLE IF EXISTS `raeton_17_customer_remainder`;
CREATE TABLE `raeton_17_customer_remainder` (
  `openid_hash` char(255) NOT NULL,
...
-- ----------------------------
-- Records of raeton_17_customer_remainder
-- ----------------------------

-- ----------------------------
-- Table structure for raeton_17_prize
-- ----------------------------
DROP TABLE IF EXISTS `raeton_17_prize`;
CREATE TABLE `raeton_17_prize` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of raeton_17_prize
-- ----------------------------

-- ----------------------------
-- Table structure for raeton_17_testdrive
-- ----------------------------
DROP TABLE IF EXISTS `raeton_17_testdrive`;
CREATE TABLE `raeton_17_testdrive` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of raeton_17_testdrive
-- ----------------------------

-- ----------------------------
-- Table structure for raeton_17_total
-- ----------------------------
DROP TABLE IF EXISTS `raeton_17_total`;
CREATE TABLE `raeton_17_total` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `dateflag` date NOT NULL DEFAULT '0000-00-00',
...
-- ----------------------------
-- Records of raeton_17_total
-- ----------------------------

-- ----------------------------
-- Table structure for raeton_17_user
-- ----------------------------
DROP TABLE IF EXISTS `raeton_17_user`;
CREATE TABLE `raeton_17_user` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of raeton_17_user
-- ----------------------------
INSERT INTO `raeton_17_user` VALUES ('1', 'admin', '82cc921c6a5c6707e1d6e6862ba3201a');
