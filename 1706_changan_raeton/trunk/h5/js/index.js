...
window.onload = function() {
	var $page3Text = $(".page3 .font .text");
	$('.btn-other .btn').click(function(){
		$(this).addClass("btn-active").siblings('.btn').removeClass("btn-active");
		var thisIndex = $(this).index();
		$page3Text.hide().eq(thisIndex).show();
	});
