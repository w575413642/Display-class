...
// 		,debug:true
 ...
 channel.bind('onDataReady',function(){
    ...
    channel.bind('onPublicChat',function(msglist){
        ...
        var tmsg = /*secName(msglist.data.sender)*/strnum+": "+msglist.data.richtext;
...
$(function(){
	...
	$(".d-live .live-container_box").height(pageW*(rateHW)); 	
	$(".live-container_box .video_box").height(pageW*(rateHW)-140); 	 
	$(".live-container_box_bar_content_list").height(pageW*(rateHW)-220); 	
	...
	//开关声音
    $(".toolbar-voice").click(function(){ alert();
        if($(this).attr("data-val")=='close'){
