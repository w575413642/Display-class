...
<!-- 	<span class="add_button"><a href="javascript:changepsw();">#修改密码</a></span> -->
	...
	<div id="body">
		<form action="index.php?c=admin&m=setvote" method="post">
			<table>
				<tbody>
					<tr>
						<td>ID:</td>
						<td align="left"><input type="number" name="id" value=""></td>
					</tr>
					<tr>
						<td>增量:</td>
						<td align="left"><input type="number" name="vote" value=""></td>
					</tr>
					<tr>
						<td>&nbsp;</td>
						<td align="left" style="text-align: left;">
							<input type="submit" value="保存" style="width: 150px;">
                            <?php echo ($new !== NULL)?"增加了{$new}票":""; ?>
						</td>
					</tr>
				</tbody>
			</table>
