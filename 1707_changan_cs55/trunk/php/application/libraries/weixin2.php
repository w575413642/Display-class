...
$config = array();
$config['name']   = '云拓互动';
$config['appid']  = 'wx35212803f42d66ba';
$config['secret'] = '090e50209e5ee50f57f6852bff265136';
$weixin = new Weixin($config);
$openId = $weixin->getopenid($_GET['code'], 'http://vitara.cloud-top.com.cn/weixin2.php');
var_dump($openId);