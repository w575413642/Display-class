...
function pano2vrPlayer(g) {
    ...
    function Ea() {
        ...
        else if (ib && 0 > O && a.getTime() - Mb > 1E3 * Ob && (ca = m, Ta = a.getTime(), H = K = B = 0), Ib && 0 == Pa && 0 > O && (0 != B || 0 != K || 0 != H)) B *= 0.9, K *= 0.9, H *= 0.9, q += B, p += K, d.changeFovLog(H), 1.0E-4 > B * B + K * K + H * H && (H = K = B = 0), d.dirty = m;
        ...
        if (!S) {
            ...
            if (0 <= O) {
                ...
                for (a = 0; a < c.length; a++)
                    // fuck ios 10.3.3
                    if (Math.max(0, c[a].identifier) == O) {
    ...
    function La(a) {
        ...
        if (!S) {
            a.preventDefault();
            if (0 > O && c[0] && (Tb = (new Date).getTime(), qc = c[0].pageX, rc = c[0].pageY, jb = c[0].pageX, kb = c[0].pageY, d.d = c[0].target, c[0].target == d.control && (a = c[0].pageX, b = c[0].pageY, Ub = a, Vb = b, pa = a, qa = b, fb = a, gb = b, O = Math.max(c[0].identifier), I()), d.d)) {
                a = d.d;
    ...
    function Nc(a) {
        ...
        do b = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(g++)), d = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(g++)), f = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(g++)), k = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(g++)),
            b = b << 2 | d >> 4, d = (d & 15) << 4 | f >> 2, e = (f & 3) << 6 | k, c += String.fromCharCode(b), 64 != f && (c += String.fromCharCode(d)), 64 != k && (c += String.fromCharCode(e)); while (g < a.length);
        return c
    }
    ...
    d.U = function(a) {
        ...
        for (var a = a.firstChild,
            ...
            if ("view" == a.nodeName) {
                ...
                for (c = a.firstChild; c;) "start" == c.nodeName && (b = c.getAttributeNode("pan"), gc = q = Number(b ? b.nodeValue : 0), b = c.getAttributeNode("tilt"), hc = p = Number(b ? b.nodeValue : 0), b = c.getAttributeNode("fov"), tb = t = Number(b ? b.nodeValue : 70)), "min" == c.nodeName && (b = c.getAttributeNode("pan"), Sa = 1 * (b ? b.nodeValue : 0), b = c.getAttributeNode("tilt"), va = 1 * (b ? b.nodeValue : -90), b = c.getAttributeNode("fov"), ka = 1 * (b ? b.nodeValue : 5), 1.0E-8 > ka && (ka = 1.0E-8)), "max" == c.nodeName && (b = c.getAttributeNode("pan"), Ra = 1 * (b ? b.nodeValue : 0), b = c.getAttributeNode("tilt"), ua = 1 * (b ? b.nodeValue : 90), b = c.getAttributeNode("fov"), ja = 1 * (b ? b.nodeValue : 120), 180 <= ja && (ja = 179.9)), c = c.nextSibling
            }
